            ...
            <div class="shadow-inner shadow-white-op-25 bg-preto-ebano w-card-guia h-card-guia rounded-50">
                ...
                <div class="ml-10 space-y-1 mt-3 text-yellow-xl">
                    ...
                    <ul class="list-square ml-10 text-base text-white">
                        ...
                        <li>Todas os itens são adquiridos via Drop ou em nossa Loja de Coins</li>
                        <li>Itens Boss adicionados para valorizar o servidor, configurados de forma balanceada</li>
                        <li>Mapas Principais: Oásis, Templo Maldito - Norte, Arma Antiga, Lago Congelado (Mapa VIP)</li>
                    ...
                    <ul class="list-square ml-10 text-base text-white">
                        ...
                        <li>Sistema de transferência de créditos por trade</li>
                        <li>Sistema de PVP pressionando a tecla (K)</li>
                        <li>Velocidade dos personagens padronizada</li>
                        <li>Guia iniciante pressionando a tecla (G)</li>
                        <li>Sistema de quests pressionando a tecla (Q)</li>
                        <li>Sistema de Kills e Patente</li>
                        <li>Sistema de Domínio de Mapa (Santuário)</li>
                        <li>Host BR, aperfeiçoamento a sincronização do usuário com os demais jogadores</li>
                        <li>Gold valorizado</li>
                        <li>Sistema de Time Shop</li>
                        <li>Sistema de Fidelidade Shop</li>
                        <li>Montarias (personagem é derrubado ao sofrer ataque)</li>
                    </ul>
                </div>
            </div>
        </div>
